...
class ProcessBedAndBreakfastTransactionsTest {
    ...
    @BeforeAll
    private fun setup() {
        outstandingTransactions.buyTransactions.addAll(listOf(BUY_TRANSACTION_1))
    ...
    /**
     * Test the profitOrLoss reporting section of the reportBedAndBreakfastTransaction method.
     *
     * Acceptance criteria:
    ...
    fun reportBedAndBreakfastTransactionProfitOrLossTest(profitOrLoss: Double) {
